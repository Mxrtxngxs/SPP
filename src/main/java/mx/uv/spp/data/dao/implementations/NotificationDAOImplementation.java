...
public class NotificationDAOImplementation implements INotificationDAO {
    ...
    @Override
    public boolean saveNotification(NotificationDTO notification) throws DatabaseException {
        try (PreparedStatement statement = connection.prepareStatement(SQL_SAVE_NOTIFICATION)) {
            ...
            throw new DatabaseException("Error al guardar la notificacion", e);
        }
    }

    @Override
    public NotificationDTO findNotificationById(Integer id) throws DatabaseException {
    ...
    @Override
    public List<NotificationDTO> findAllNotifications() throws DatabaseException {
    ...
    @Override
    public boolean updateNotification(NotificationDTO notification) throws DatabaseException {
    ...
    @Override
    public boolean deleteNotificationById(Integer id) throws DatabaseException {
