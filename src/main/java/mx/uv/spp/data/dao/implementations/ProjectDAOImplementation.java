...
public class ProjectDAOImplementation implements IProjectDAO {
    ...
    public boolean saveProject(ProjectDTO project) {
        try (PreparedStatement statement = connection.prepareStatement(SQL_SAVE_PROJECT)) {
            ...
            throw new DatabaseException("Error saving project", e);
        }
    }
    ...
    public boolean deleteProject(int projectId) {
        try (PreparedStatement statement = connection.prepareStatement(SQL_DELETE_PROJECT)) {
            ...
            throw new DatabaseException("Error deleting project ID: " + projectId, e);
        }
    }
    ...
    public boolean incrementAssignedInterns(int projectId) {
        try (PreparedStatement statement = connection.prepareStatement(SQL_INCREMENT_ASSIGNED)) {
            ...
            throw new DatabaseException("Error incrementing assigned interns for project ID: " + projectId, e);
        }
    }
    ...
    public ProjectDTO getProjectById(int projectId) {
        try (PreparedStatement statement = connection.prepareStatement(SQL_FIND_BY_ID)) {
            ...
            throw new DatabaseException("Error finding project ID: " + projectId, e);
        }
        return null;
    }
    ...
    private List<ProjectDTO> getProjectList(String query) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(query);
            ...
            throw new DatabaseException("Error listing projects", e);
        }
        return list;
    }
