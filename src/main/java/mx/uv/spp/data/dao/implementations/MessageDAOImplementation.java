...
public class MessageDAOImplementation implements IMessageDAO {
    ...
    @Override
    public boolean saveMessage(MessageDTO message) throws DatabaseException {
    ...
    @Override
    public MessageDTO findMessageById(Integer id) throws DatabaseException {
    ...
    @Override
    public List<MessageDTO> findAllMessages() throws DatabaseException {
    ...
    @Override
    public boolean updateMessage(MessageDTO message) throws DatabaseException {
    ...
    @Override
    public boolean deleteMessageById(Integer id) throws DatabaseException {
