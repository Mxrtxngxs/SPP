...
import mx.uv.spp.data.dao.ITemplateDAO;
...
public class TemplateDAOImplementation implements ITemplateDAO {
    ...
    public TemplateDAOImplementation() {
        this.connection = DatabaseConfig.getInstance().getConnection();
    }

    @Override
    public boolean saveTemplate(TemplateDTO template) throws DatabaseException {
        try (PreparedStatement statement = connection.prepareStatement(SQL_SAVE)) {
            ...
            throw new DatabaseException("Error saving template", e);
        }
    }

    @Override
    public boolean updateTemplate(TemplateDTO template) throws DatabaseException {
        try (PreparedStatement statement = connection.prepareStatement(SQL_UPDATE)) {
            ...
            throw new DatabaseException("Error updating template ID: " + template.getTemplateId(), e);
        }
    }

    @Override
    public boolean deleteTemplate(int templateId) throws DatabaseException {
        try (PreparedStatement statement = connection.prepareStatement(SQL_DELETE)) {
            statement.setInt(1, templateId);
            return statement.executeUpdate() > 0;
        } catch (SQLException e) {
            throw new DatabaseException("Error deleting template ID: " + templateId, e);
        }
    }

    @Override
    public TemplateDTO getTemplateById(int templateId) throws DatabaseException {
        try (PreparedStatement statement = connection.prepareStatement(SQL_FIND_BY_ID)) {
            ...
            throw new DatabaseException("Error finding template ID: " + templateId, e);
        }
        return null;
    }

    @Override
    public List<TemplateDTO> getAllTemplates() throws DatabaseException {
        return getTemplateList(SQL_FIND_ALL, null);
    }

    @Override
    public List<TemplateDTO> getTemplatesByProfessorId(int professorId) throws DatabaseException {
        return getTemplateList(SQL_FIND_BY_PROFESSOR, professorId);
    }

    private List<TemplateDTO> getTemplateList(String query, Integer param) throws DatabaseException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            throw new DatabaseException("Error listing templates", e);
        }
        return list;
    }
